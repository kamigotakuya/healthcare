...
public class TaskRepository {
  ...
  /** SQL 1件追加 */
  private static final String SQL_INSERT_ONE = "INSERT INTO task_t(id, user_id, title, limitday, complete) VALUES((SELECT MAX(id) + 1 FROM task_t), :userId, :title, :limitday, false)";
